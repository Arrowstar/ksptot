...
MAKEFILE = dotARH_mex.mk

include dotARH_mex.mki
...
MEX_FILE_NAME_WO_EXT = dotARH_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\dotARH"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\dotARH/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
