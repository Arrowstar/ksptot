...
MAKEFILE = crossARH_mex.mk

include crossARH_mex.mki
...
MEX_FILE_NAME_WO_EXT = crossARH_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\crossARH"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\crossARH/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
