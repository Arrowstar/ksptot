...
userData = get(mainGUIFigure, 'UserData');
set(hObject, 'UserData', userData);
setappdata(hObject, 'mainGUIFigure', mainGUIFigure);
...
try
    ...
    mainGUIFigure = getappdata(hObject, 'mainGUIFigure');
    userData = get(mainGUIFigure, 'UserData');
    options = userData{1,9};
    ...
    set(mainGUIFigure, 'UserData',userData);
    
    updateAppOptions(mainGUIFigure, 'ksptot', 'plotmaxdeltav', options.plotmaxdeltav); pause(0.1);
    updateAppOptions(mainGUIFigure, 'ksptot', 'porkchopptsaxes', options.porkchopptsaxes); pause(0.1);
    updateAppOptions(mainGUIFigure, 'ksptot', 'porkchopnumsynperiods', options.porkchopnumsynperiods); pause(0.1);
    updateAppOptions(mainGUIFigure, 'ksptot', 'departplotnumoptiters', options.departplotnumoptiters); pause(0.1);
    updateAppOptions(mainGUIFigure, 'ksptot', 'quant2opt', options.quant2Opt);
