...
% Last Modified by GUIDE v2.5 11-Jun-2018 20:41:08
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    refBodyID = orbitPanelGetOrbitFromSFSContextCallBack(mainGUIHandle, handles.finOrbitSMAText, handles.finOrbitECCText, handles.finOrbitINCText, handles.finOrbitRAANText, handles.finOrbitARGText);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    refBodyID = orbitPanelGetOrbitFromKSPTOTConnectCallBack(handles.finOrbitSMAText, handles.finOrbitECCText, handles.finOrbitINCText, handles.finOrbitRAANText, handles.finOrbitARGText);
...
% handles    structure with handles and user data (see GUIDATA)
    userData = get(handles.OptimalTwoBurnOrbitChangeGUI,'UserData');
    mainGUIHandle = userData{1,1};
    refBodyID = orbitPanelGetOrbitFromSFSContextCallBack(mainGUIHandle, handles.iniOrbitSMAText, handles.iniOrbitECCText, handles.iniOrbitINCText, handles.iniOrbitRAANText, handles.iniOrbitARGText);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    refBodyID = orbitPanelGetOrbitFromKSPTOTConnectCallBack(handles.iniOrbitSMAText, handles.iniOrbitECCText, handles.iniOrbitINCText, handles.iniOrbitRAANText, handles.iniOrbitARGText);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    refBodyID = orbitPanelGetOrbitFromKSPTOTConnectActiveVesselCallBack(handles.iniOrbitSMAText, handles.iniOrbitECCText, handles.iniOrbitINCText, handles.iniOrbitRAANText, handles.iniOrbitARGText);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    refBodyID = orbitPanelGetOrbitFromKSPTOTConnectActiveVesselCallBack(handles.finOrbitSMAText, handles.finOrbitECCText, handles.finOrbitINCText, handles.finOrbitRAANText, handles.finOrbitARGText);
