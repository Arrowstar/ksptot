    ...
    methods(Access=private)
        ...
        function checkValidationOrchestrator(testCase)
            ...
            expectedOrder = { ...
                ...
                'EngineWithoutTankValidator', ...
                'TankWithoutConsumerValidator', ...
                'NonPositiveStageDryMassValidator', ...
                'ZeroAreaLiftModelValidator', ...
                'EngineActiveOnInactiveStageValidator', ...
                'ThrottleBelowMinimumValidator', ...
                'ElectricEngineWithoutChargeValidator', ...
                'GraphicalAnalysisTaskFailureValidator'};
