...
cbName = lower(contents{get(hObject,'Value')});
...
contents = cellstr(get(handles.orbitingAboutCombo,'String'));
cbName = lower(contents{get(handles.orbitingAboutCombo,'Value')});
...
if(isempty(errMsg))
    try
        if(iniOrbit(1) > 0)
            p1 = computePeriod(iniOrbit(1), gmuXfr);
        else
            n1 = computeMeanMotion(iniOrbit(1), gmuXfr);
...
%             dMA = MA2-MA1;
        ...
        if(finOrbit(1) > 0)
            p2 = computePeriod(finOrbit(1), gmuXfr);
        else
            n2 = computeMeanMotion(finOrbit(1), gmuXfr);
...
orbitPanelGetOrbitFromSFSContextCallBack(mainGUIHandle, handles.finOrbitSMAText, handles.finOrbitECCText, handles.finOrbitINCText, handles.finOrbitRAANText, handles.finOrbitARGText, handles.finOrbitMEANText, handles.finOrbitEPOCHText);

function getFinalOrbitFromKSPTOTConnect_Callback(hObject, eventdata, handles)
% hObject    handle to getFinalOrbitFromSFSFile (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
orbitPanelGetOrbitFromKSPTOTConnectCallBack(handles.finOrbitSMAText, handles.finOrbitECCText, handles.finOrbitINCText, handles.finOrbitRAANText, handles.finOrbitARGText, handles.finOrbitMEANText, handles.finOrbitEPOCHText);
...
userData = get(handles.rendezvousGUI,'UserData');
mainGUIHandle = userData{1,1};
orbitPanelGetOrbitFromSFSContextCallBack(mainGUIHandle, handles.iniOrbitSMAText, handles.iniOrbitECCText, handles.iniOrbitINCText, handles.iniOrbitRAANText, handles.iniOrbitARGText, handles.iniOrbitMEANText, handles.iniOrbitEPOCHText);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
orbitPanelGetOrbitFromKSPTOTConnectCallBack(handles.iniOrbitSMAText, handles.iniOrbitECCText, handles.iniOrbitINCText, handles.iniOrbitRAANText, handles.iniOrbitARGText, handles.iniOrbitMEANText, handles.iniOrbitEPOCHText);
...
if(~isempty(selName))
    ...
    set(handles.iniOrbitSMAText, 'String', num2str(bodyInfo.sma));
    set(handles.iniOrbitECCText, 'String', num2str(bodyInfo.ecc));
    set(handles.iniOrbitINCText, 'String', num2str(bodyInfo.inc));
    set(handles.iniOrbitRAANText, 'String', num2str(bodyInfo.raan));
    set(handles.iniOrbitARGText, 'String', num2str(bodyInfo.arg));
    set(handles.iniOrbitMEANText, 'String', num2str(bodyInfo.mean));
    set(handles.iniOrbitEPOCHText, 'String', num2str(bodyInfo.epoch));
    set(hObject, 'Value', 1);
end
...
if(~isempty(selName))
    bodyInfo = celBodyData.(lower(selName));
    set(handles.finOrbitSMAText, 'String', num2str(bodyInfo.sma));
    set(handles.finOrbitECCText, 'String', num2str(bodyInfo.ecc));
    set(handles.finOrbitINCText, 'String', num2str(bodyInfo.inc));
    set(handles.finOrbitRAANText, 'String', num2str(bodyInfo.raan));
    set(handles.finOrbitARGText, 'String', num2str(bodyInfo.arg));
    set(handles.finOrbitMEANText, 'String', num2str(bodyInfo.mean));
    set(handles.finOrbitEPOCHText, 'String', num2str(bodyInfo.epoch));
    set(hObject, 'Value', 1);
end
...
% handles    structure with handles and user data (see GUIDATA)
    pasteOrbitFromClipboard(handles.finOrbitEPOCHText, handles.finOrbitSMAText, handles.finOrbitECCText, ...
                                 ...
                                 handles.finOrbitMEANText, false);
...
% handles    structure with handles and user data (see GUIDATA)
    copyOrbitToClipboardFromText(handles.iniOrbitEPOCHText, handles.iniOrbitSMAText, handles.iniOrbitECCText, ...
                                 ...
                                 handles.iniOrbitMEANText, false);
