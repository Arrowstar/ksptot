...
% Last Modified by GUIDE v2.5 13-May-2021 10:28:47
...
function populateGUI(handles, constraint, lvdData)
    ...
    setappdata(handles.lvd_EditGeometricAngleConstraintGUI,'frame',frame);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    curFrame = getappdata(handles.lvd_EditGeometricAngleConstraintGUI,'frame');
    curFrame = curFrame.editFrameDialogUI(EditReferenceFrameContextEnum.ForState);
    
    setappdata(handles.lvd_EditGeometricAngleConstraintGUI,'frame',curFrame);
...
function updateFrameChange(handles)
    lvdData = getappdata(handles.lvd_EditGeometricAngleConstraintGUI,'lvdData');
...
%             end
    ...
    setappdata(handles.lvd_EditGeometricAngleConstraintGUI,'frame', newFrame);
