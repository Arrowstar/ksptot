...
% Last Modified by GUIDE v2.5 03-Dec-2018 17:03:27
...
% --- Executes on key press with focus on lvd_EditActionSetEngineToTankConnStateGUI or any of its controls.
function lvd_EditActionSetEngineToTankConnStateGUI_WindowKeyPressFcn(hObject, eventdata, handles)
% hObject    handle to lvd_EditActionSetEngineToTankConnStateGUI (see GCBO)
