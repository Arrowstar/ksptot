function generatePorkChopPlot(mainGUIHandle)
    ...
    [departDV, arrivalDV, totalDV, departTimeArr, arrivalTimeArr] = computePorkChopData(celBodyData, departName, earlyDepartTime, arrivalName, earlyArrivalTime, gmu, options);
