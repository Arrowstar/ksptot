function [str] = printXfrOrbitsMFMSToTextbox(hTransferOrbitsText,waypoints, xferOrbits, form, paddLen)
...
%   Detailed explanation goes here
        ...
        for(i=1:size(xferOrbits,1))
            ...
            str{end+1} = [paddStr('Eccentricity = ', paddLen), num2str(xferOrbits(i,2))];
