...
%     end
    ...
    [rVect1,vVect1Pre]=getStatefromKepler(iniOrbit(1), iniOrbit(2), iniOrbit(3), iniOrbit(4), iniOrbit(5), burn1TA, gmuXfr);
    [rVect2,vVect2Post]=getStatefromKepler(finOrbit(1), finOrbit(2), finOrbit(3), finOrbit(4), finOrbit(5), burn2TA, gmuXfr);
