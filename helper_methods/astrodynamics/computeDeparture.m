function computeDeparture(celBodyData, departBody, arrivalBody, departUT, arrivalUT, eSMA, eEcc, eInc, eRAAN, eArg, gmuXfr, cBody, options, eMA, eEpoch)
    ...
    [dV, dVVect, dVVectNTW, eRVect, hOrbit] = computeDepartArriveDVFromEllipticTarget(eSMA, eEcc, eInc, eRAAN, eArg, eTA, gmuDepartBody, hVInf);
%     [sUnitVector, OUnitVector] = hyperOrbitExcessVelConstMath(eSMA, eEcc, eInc, eRAAN, eArg, eTA, gmuDepartBody, hVInf);
   
    %Departure display
    [hDepartArr, ~] = departDisplayGUI();
...
%     hTA = hOrbit(6);
    ...
    hyperOrbitText3 = [paddStr('Eccentricity = ', paddLen), num2str(hEcc)];
    ...
    hyperOrbitTextstr = {hyperOrbitText1, hyperOrbitText11, hyperOrbitText2, hyperOrbitText3, hyperOrbitText4, hyperOrbitText5, hyperOrbitText6};
    ...
    xferOrbitText3 = [paddStr('Eccentricity = ', paddLen), num2str(eccX)];
