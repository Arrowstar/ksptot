...
%   Detailed explanation goes here
    ...
    if(norm(rVect) <= 1.025*bodyInfo.radius)
...
%     aeroDvVect = getAerobrakeDeltaV(bodyInfo, ut, rVect, vVect, dragCoeff, mass, dragModel);
%     
% 	thruster.isp = 0;
% 	thruster.propType = 'none';
%     
%     eventLog = ma_executeDVManeuver_dv_inertial(aeroDvVect, thruster, initialState, eventNum);
end
