function [selection,value] = listdlgARH(varargin)
...
if isempty(initialvalue) && smode==1
    initialvalue = 1;
end
...
set(fig,'Position',getnicedialoglocationARH(fp, get(fig,'Units')));
% Make ok_btn the default button.
setdefaultbuttonARH(fig, ok_btn);
