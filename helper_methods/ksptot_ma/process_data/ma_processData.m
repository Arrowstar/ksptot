...
%   Detailed explanation goes here3
    ...
    %%%%%%%%%%
    ma_UpdateStateReadout(handles.initialStateReadoutLabel, 'initial', maData.stateLog, celBodyData);
    ma_UpdateStateReadout(handles.finalStateReadoutLabel, 'final', maData.stateLog, celBodyData);
    drawnow;
end
