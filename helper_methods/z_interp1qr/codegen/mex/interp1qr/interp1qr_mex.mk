START_DIR = C:\Users\Adam\Dropbox\DOCUME~1\homework\PERSON~1\KSPTRA~1\HELPER~1\Z_INTE~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017b
MAKEFILE = interp1qr_mex.mk

include interp1qr_mex.mki
...
MEX_FILE_NAME_WO_EXT = interp1qr_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\interp1qr"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\interp1qr/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\interp1qr/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\interp1qr/%.cu
	$(CC) $(CCFLAGS) "$<"
