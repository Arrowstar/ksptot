...
$(document).ready(function() {
    ...
    queries.potentialDifferences = $("> div#potentialDifferencesBody", queries.south);
    ...
    queries.potentialDifferencesLink = $('> ul > li > span#potentialDifferences', queries.south);
...
// Make the potential differences table sortable.
function setupPotentialDifferences() {
    queries.potentialDiffTable = $(".grid", $("> div#potentialDifferencesBody", queries.south));
    queries.potentialDiffTable.tablesorter();
}
...
function selectPotentialDifferencesTab() {
    queries.potentialDifferencesLink.mousedown();
    $('a', queries.potentialDifferences).filter(':first').focus();
}
