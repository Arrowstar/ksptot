function [pointsOut, posOut, faceIndsOut] = vect_intersectLineMesh3d(lines, vertices, faces, varargin)
    ...
    for(i=1:numLines)
        ...
        valid = abs(b) > tol & vectorNorm3d_N > tol;
