classdef SetGenericSumOfSinesSteeringModelActionOptimVar < AbstractOptimizationVariable
    %SetGenericSumOfSinesSteeringModelActionOptimVar Summary of this class goes here
    %   Detailed explanation goes here
    
    properties
        varObj = GenericSumOfSinesSteeringModel.getDefaultSteeringModel()
    ...
    methods
        function obj = SetGenericSumOfSinesSteeringModelActionOptimVar(varObj)
            obj.varObj = varObj;
