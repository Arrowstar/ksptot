classdef PositionContinuityConstraintX < AbstractConstraint
    %PositionContinuityConstraintX Summary of this class goes here
    ...
    methods
        function obj = PositionContinuityConstraintX(event, constraintEvent)
            obj.event = event; 
...
%                 frame = topLevelBodyInfo.getBodyCenteredInertialFrame();
    ...
    methods(Static)
        function constraint = getDefaultConstraint(~, ~)            
            constraint = PositionContinuityConstraintX(LaunchVehicleEvent.empty(1,0), LaunchVehicleEvent.empty(1,0));
        end
    end
end