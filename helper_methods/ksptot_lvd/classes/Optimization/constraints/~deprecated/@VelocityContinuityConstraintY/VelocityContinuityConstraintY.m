classdef VelocityContinuityConstraintY < AbstractConstraint
    %VelocityContinuityConstraintY Summary of this class goes here
    ...
    methods
        function obj = VelocityContinuityConstraintY(event, constraintEvent)
            obj.event = event; 
...
%                 frame = topLevelBodyInfo.getBodyCenteredInertialFrame();
    ...
    methods(Static)
        function constraint = getDefaultConstraint(~, ~)            
            constraint = VelocityContinuityConstraintY(LaunchVehicleEvent.empty(1,0), LaunchVehicleEvent.empty(1,0));
        end
    end
end