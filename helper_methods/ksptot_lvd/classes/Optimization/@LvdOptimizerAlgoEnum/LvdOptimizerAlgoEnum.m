classdef LvdOptimizerAlgoEnum < matlab.mixin.SetGet
    ...
    enumeration
        ...
        AdamNlOpt('AdamNLOpt', ...
              'A primal-dual interior-point / trust-region / SQP hybrid with filter globalization, feasibility restoration, and automatic finite-difference step calibration.  Well suited to expensive, slightly noisy objective and constraint functions.', ...
              true);
    end
