classdef DragCoefficientModelEnum < matlab.mixin.SetGet
    ...
    enumeration
        ...
        kOSModel('kOS Model',"Uses data generated by the included kOS script 'createDragData.ks' and Ren0k's 'Project Atmospheric Data' kOS functions to create a drag model as function of Mach number, AoA, and sideslip angle.");
    end
