classdef ODE89Integrator < AbstractFirstOrderIntegrator
    %ODE89Integrator Summary of this class goes here
    %   Detailed explanation goes here
    
    properties
        options(1,1) BuiltInIntegratorOptions = BuiltInIntegratorOptions();
        integratorEnum = IntegratorEnum.ODE89;
    end
    
    methods
        function obj = ODE89Integrator(options)
            if(nargin > 0)
                obj.options = options;
            else
        ...
        function [t,y,te,ye,ie] = integrate(obj, odefun, tspan, y0, evtsFunc, odeOutputFun)
            ...
            [t,y,te,ye,ie] = ode89(odefun, tspan, y0, optionsToUse);
        end
