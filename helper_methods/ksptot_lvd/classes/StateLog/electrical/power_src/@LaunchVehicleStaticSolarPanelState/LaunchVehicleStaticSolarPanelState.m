classdef LaunchVehicleStaticSolarPanelState < AbstractLaunchVehicleElectricalPowerSrcState
...
%         stageState = LaunchVehicleStageState.empty(1,0); %(1,1) LaunchVehicleStageState
        ...
        src = LaunchVehicleStaticSolarPanel.empty(1,0); %(1,1) LaunchVehicleStaticSolarPanel
        active(1,1) logical = true;
    end
    
    methods
        function obj = LaunchVehicleStaticSolarPanelState(stageState, src)
